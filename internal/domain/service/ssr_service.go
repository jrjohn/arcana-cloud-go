...
// ssrService implements SSRService
type ssrService struct {
	reactEngine   SSREngine
	angularEngine SSREngine
...
func NewSSRService(cacheEnabled bool, cacheTTL time.Duration) SSRService {
	s := &ssrService{
...
func (s *ssrService) SetReactEngine(engine SSREngine) {
	s.reactEngine = engine
}

// SetAngularEngine sets the Angular rendering engine
func (s *ssrService) SetAngularEngine(engine SSREngine) {
	s.angularEngine = engine
}

func (s *ssrService) RenderReact(ctx context.Context, component string, props map[string]any) (*SSRRenderResult, error) {
...
func (s *ssrService) RenderAngular(ctx context.Context, component string, props map[string]any) (*SSRRenderResult, error) {
...
func (s *ssrService) GetStatus(ctx context.Context) (*SSRStatus, error) {
	s.statsMutex.RLock()
...
func (s *ssrService) getFromCache(key string) *SSRRenderResult {
	s.cacheMutex.RLock()
...
func (s *ssrService) putInCache(key string, result *SSRRenderResult) {
	s.cacheMutex.Lock()
	defer s.cacheMutex.Unlock()
